...
export const sampleCourses: Course[] = [
    {id: '1', price: 199, subject: 'Physics', name: 'One', cols: 1, rows: 1, subText, availableBookings: booking , color: 'lightblue', details: sampleText, features: features, content: courseContent},
    {id: '2', price: 299, subject: 'Physics', name: 'Two', cols: 1, rows: 1, subText, availableBookings: booking, color: 'lightgreen', details: sampleTextV2, features: features, content: courseContent},
    {id: '3', price: 199, subject: 'English', name: 'Three', cols: 1, rows: 1, subText, availableBookings: booking, color: 'lightpink', details: sampleText, features: features, content: courseContent},
    {id: '4', price: 299, subject: 'Chemistry', name: 'Four', cols: 1, rows: 1, subText, availableBookings: booking, color: '#DDBDF1', details: sampleTextV2, features: features, content: courseContent},
    {id: '5', price: 199, subject: 'Chemistry', name: 'Five', cols: 1, rows: 1, subText, availableBookings: booking, color: 'lightblue', details: sampleText, features: features, content: courseContent},
    {id: '6', price: 299, subject: 'Biology', name: 'Six', cols: 1, rows: 1, subText, availableBookings: booking, color: 'lightgreen', details: sampleTextV2, features: features, content: courseContent},
    {id: '7', price: 199, subject: 'Biology', name: 'Seven', cols: 1, rows: 1, subText, availableBookings: booking, color: 'lightpink', details: sampleText, features: features, content: courseContent},
    {id: '8', price: 299, subject: 'Mathematics', name: 'Eight', cols: 1, rows: 1, subText, availableBookings: booking, color: '#DDBDF1', details: sampleTextV2, features: features, content: courseContent},
  ];